...
import { PageProps, Validation } from "./Login";
    ...
    return (
        <div className="container">
            <div className="header">
                <div className="text">Редактирование пользователя</div>
            ...
            <div className="submit-container">
                    <button className="submit" disabled={!(val.username && val.password)} onClick={async (e) => { 
                        ...
                        try {
                            ...
                            const res = await axios.patch(`https://test-assignment.emphasoft.com/api/v1/users/${id}`, {
                                username: username,
